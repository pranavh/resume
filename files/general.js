...
jQuery(function($) { 
	...
	$('#myad').html(function(){
		var a = "North Carolina State University<br />";
		var b = "Dept. of Mechanical and Aerospace Engineering<br />";
		var c = "Engineering Building 3, Campus Box 7910<br />";
		var d = "911 Oval Dr.<br />";
		var e = "Raleigh, NC 27695-7910";
		//var h = "https://www.google.com/maps/place/NC+State+University+-+Engineering+Building+3/@35.7708821,-78.6739245,19z";
		//$(this).parent('a').attr('href', h);
		return a + b + c + d + e;
	});
